...
Original file is located at
    https://colab.research.google.com/drive/1MENoj7sDMSEgfZ_rV5Ol3lfeoD8PtLms
"""
...
show_image(image, 'tiger')

print('*** Done by %s at ' % ts3,today, type(today))
# 實作: Show teapot

# 你的程式
img_url = images_for_test_map['teapot']
image, original_image = load_image(img_url, image_size, dynamic_size, max_dynamic_size)
show_image(image, 'teapot')
print('*** Done by %s at ' % ts3,today, type(today))
# 實作: Show turtle
